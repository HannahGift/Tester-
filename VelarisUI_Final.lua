                ...
                local function OpenCP()
                    ...
                    SatMap.InputBegan:Connect(function(inp)
                        if inp.UserInputType == Enum.UserInputType.MouseButton1 or inp.UserInputType == Enum.UserInputType.Touch then
                            MC2 = Mouse_cp2.Move:Connect(function()
                                local mx = SatMap.AbsolutePosition.X
                                local my = SatMap.AbsolutePosition.Y
                                S2 = math.clamp((Mouse_cp2.X-mx)/SatMap.AbsoluteSize.X,0,1)
                                V2 = 1-math.clamp((Mouse_cp2.Y-my)/SatMap.AbsoluteSize.Y,0,1)
                                Refresh2()
                            end)
                        end
                    end)
                    SatMap.InputEnded:Connect(function(inp)
                        if (inp.UserInputType==Enum.UserInputType.MouseButton1 or inp.UserInputType==Enum.UserInputType.Touch) and MC2 then
                            MC2:Disconnect() MC2=nil
                        end
                    end)
                    HueSlider.InputBegan:Connect(function(inp)
                        if inp.UserInputType == Enum.UserInputType.MouseButton1 or inp.UserInputType == Enum.UserInputType.Touch then
                            MC2 = Mouse_cp2.Move:Connect(function()
                                H2 = math.clamp((Mouse_cp2.Y-HueSlider.AbsolutePosition.Y)/HueSlider.AbsoluteSize.Y,0,1)
                                Refresh2()
                            end)
                        end
                    end)
                    ...
                    if Config.Transparency and TransSlider2 then
                        TransSlider2.InputBegan:Connect(function(inp)
                            if inp.UserInputType == Enum.UserInputType.MouseButton1 or inp.UserInputType == Enum.UserInputType.Touch then
                                MC2 = Mouse_cp2.Move:Connect(function()
                                    T2 = 1-math.clamp((Mouse_cp2.Y-TransSlider2.AbsolutePosition.Y)/TransSlider2.AbsoluteSize.Y,0,1)
                                    Refresh2()
                                end)
                            end
                        end)
                        TransSlider2.InputEnded:Connect(function(inp)
                            if (inp.UserInputType==Enum.UserInputType.MouseButton1 or inp.UserInputType==Enum.UserInputType.Touch) and MC2 then
                                MC2:Disconnect() MC2=nil
                            end
                        end)
                    ...
                    Overlay.MouseButton1Click:Connect(function() Colorpicker2:SetValue({origH,origS,origV},origT) DialogGui:Destroy() end)
                end
...
do
    ...
    function Chloex:_BuildSettingsTab(Tabs, GuiConfig, gameName)
        ...
        UISection:AddColorPicker("Settings_Accent", {
            Title    = "Accent Color",
            ...
            Callback = function(color)
                ...
                pcall(function()
                    ...
                    if main then
                        local tint = main:FindFirstChild("ColorTint")
                        if tint then tint.BackgroundColor3 = color end
                    end
                end)
            end,
        })
        ...
        UISection:AddSlider({
            ...
            Callback = function(val)
                ...
                pcall(function()
                    ...
                    local main = sg:FindFirstChild("Main", true)
                    if main then
                        TweenService2:Create(main, TweenInfo.new(0.3), {
        ...
        UISection:AddSlider({
            ...
            Callback = function(val)
                pcall(function()
                    ...
                    local sg = cg:FindFirstChild("Chloeex")
                    if not sg then return end
                    for _, c in sg:GetDescendants() do
