    ...
    function Chloex:_BuildSettingsTab(Tabs, GuiConfig, gameName)
        ...
        local function ApplyAccentColor(color)
            ...
            pcall(function()
                ...
                for _, v in sg:GetDescendants() do
                    if v.Name == "ChooseFrame" or v.Name == "MainStroke" then
                        if v:IsA("Frame") then v.BackgroundColor3 = color end
                    end
                    if v.Name == "UIStroke" and v.Parent and v.Parent.Name == "ChooseFrame" then
                        v.Color = color
                    end
                end
            end)
